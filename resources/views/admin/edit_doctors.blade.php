    ...
    <div class="mt-4">
        <form action="{{ route('update_doctor', $doctor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-3">
                ...
                <input type="tel" class="form-control" name="phone" value="{{ $doctor->phone }}" id="phone"
                    placeholder="Add the Doctor Phone Number ">
            </div>
            <div class="mt-3">
                <label for="">Doctor Position</label>
                <input type="text" class="form-control" name="position" value="{{ $doctor->position }}" id="position"
            ...
            <div class="mt-3">
                ...
                <input type="number" class="form-control" name="years_of_experience"
                    value="{{ $doctor->years_of_experience }}" id="years_of_experience"
            ...
            <div class="mt-3">
                ...
                <input type="text" class="form-control" name="university" id="university"
                    value="{{ $doctor->university }}" placeholder="Add the Doctor University">
            </div>
            <div class="mt-3">
                <label for="">Doctor Description</label>
                <textarea name="description" id="description" class="form-control" rows="4"
                    placeholder="Add the Doctor Description">{{ $doctor->description }}</textarea>
            </div>
            <div class="mt-3">
                ...
                @else
                    <img src="{{ asset('uploads/doctors/' . $doctor->image) }}" alt=""
                        style="width: 100%; height: 300px; border-radius: 100px; object-fit: cover;">
                @endif
            </div>
            <div class="mt-3">
