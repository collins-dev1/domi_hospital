...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>Eye Clinic</h1>
            <p>Our Eye Clinic is dedicated to protecting and improving your vision. We provide expert care for eye
                conditions, vision testing, treatment of common and complex eye problems, and preventive eye health
                services to help you see clearly and live better.</p>
        ...
        <div class="container">
            <div class="service-detail-content">
                <div class="service-detail-text fade-in">
                    <h3>Eye Clinic</h3>
                    <p>The Eye Clinic is dedicated to the prevention, diagnosis, and treatment of a wide range of eye
                        and vision problems. Good eyesight is essential for daily life, learning, and overall quality of
                        health. Our clinic provides both routine vision care and advanced eye treatments to ensure
                        patients of all ages maintain healthy vision.</p>
                ...
                <div class="service-detail-image fade-in">
                    <img src="https://i.pinimg.com/736x/8b/ca/72/8bca7200d4e4ae8013837b80c650e3ea.jpg"
    ...
    <section>
        <div class="section-header">
            <h2>Key Areas of Eye Clinic</h2>
        </div>

        <div class="service-header">
            <div>
                <h3>Why Eye Care is Important</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Eyes are one of the most sensitive and vital organs.</li>
                        <li><i class="fas fa-check"></i> Regular eye checkups help detect conditions early, such as
                            glaucoma, cataracts, or diabetic eye disease, before they cause permanent damage.</li>
                        <li><i class="fas fa-check"></i> Vision problems can affect children’s learning, adult
                            productivity, and seniors’ independence.</li>
                    </ul>
                </div>
            </div>
            <div style="margin-top: 3rem;">
                <h3>Common Eye Conditions We Treat</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Refractive Errors – Nearsightedness (myopia), farsightedness
                            (hyperopia), astigmatism, and presbyopia.
                        <li>
                        <li><i class="fas fa-check"></i> Cataracts – Clouding of the eye’s natural lens, common with
                            aging.
                        <li>
                        <li><i class="fas fa-check"></i> Glaucoma – Increased eye pressure that can damage the optic
                            nerve.
                        <li>
                        <li><i class="fas fa-check"></i> Conjunctivitis (Pink Eye) – Infections or allergies affecting
                            the eye surface.
                        <li>
                        <li><i class="fas fa-check"></i> Diabetic Retinopathy – Eye damage caused by uncontrolled
                            diabetes.
                        <li>
                        <li><i class="fas fa-check"></i> Dry Eye Syndrome – Inadequate tear production causing
                            irritation.
                        <li>
                        <li><i class="fas fa-check"></i> Macular Degeneration – Age-related condition leading to central
                            vision loss.
                        <li>
                    </ul>
                </div>
            ...
            <div style="margin-top: 3rem;">
                <h3>Services Offered in the Eye Clinic</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Routine Eye Exams – Vision testing, prescription for glasses
                            or contact lenses.
                        <li>
                        <li><i class="fas fa-check"></i> Screening & Diagnosis – Early detection of eye diseases.
                        <li>
                        <li><i class="fas fa-check"></i> Medical & Surgical Care – Treatment of cataracts, glaucoma,
                            and other complex conditions.
                        <li>
                        <li><i class="fas fa-check"></i> Pediatric Eye Care – Specialized care for children’s vision.
                        <li>
                        <li><i class="fas fa-check"></i> Geriatric Eye Care – Managing age-related eye issues.
                        <li>
                        <li><i class="fas fa-check"></i> Emergency Eye Care – For injuries, infections, or sudden
                            vision loss.
                        <li>
                        <li><i class="fas fa-check"></i> Preventive Counseling – Education on eye safety, diet, and
                            lifestyle for healthy vision.
                        <li>
                    </ul>
                </div>
            </div>
            ...
            <div style="margin-top: 3rem;">
                ...
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Have your eyes checked regularly (every 1–2 years).
                        <li>
                        <li><i class="fas fa-check"></i> Protect your eyes from UV rays by wearing sunglasses.
                        <li>
                        <li><i class="fas fa-check"></i> Maintain a healthy diet rich in Vitamin A, Omega-3 fatty
                            acids, and antioxidants.
                        <li>
                        <li><i class="fas fa-check"></i> Control underlying conditions like diabetes and hypertension.
                        <li>
                        <li><i class="fas fa-check"></i> Avoid excessive screen time or use the 20-20-20 rule (every 20
