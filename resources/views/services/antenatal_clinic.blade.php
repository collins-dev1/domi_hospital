...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>Antenatal Clinic</h1>
            <p>Our Antenatal Clinic provides specialized care and support for expectant mothers throughout pregnancy. We
                focus on regular check-ups, monitoring the health of both mother and baby, offering guidance on
                nutrition and safe delivery, and preparing families for childbirth.</p>
        ...
        <div class="container">
            <div class="service-detail-content">
                <div class="service-detail-text fade-in">
                    ...
                    <p>Our Antenatal Clinic is dedicated to the care of expectant mothers from the early stages of
                        pregnancy until delivery. Antenatal care is essential to ensure the health and well-being of
                        both mother and child, and our clinic provides a comprehensive range of services to support safe
                        and healthy pregnancies.</p>
                    <p>At our Antenatal Clinic, we combine medical expertise with compassionate care to provide mothers
                ...
                <div class="service-detail-image fade-in">
                    <img src="https://i.postimg.cc/QdfsZsJF/artn.jpg"
    ...
    <section>
        <div class="section-header">
            <h2>Key Areas of Antenatal Clinic</h2>
        </div>
        ...
        <div class="service-header">
            <div>
                ...
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Routine Check-ups – Regular medical consultations to monitor
                            maternal health, fetal growth, and detect any complications early.</li>
                        <li><i class="fas fa-check"></i> Ultrasound & Screening – Detailed scans and laboratory tests to
                            track your baby’s development and identify possible health concerns.</li>
                        <li><i class="fas fa-check"></i> Nutrition & Lifestyle Guidance – Personalized advice on diet,
                            supplements, and lifestyle adjustments to promote a safe pregnancy.</li>
                        <li><i class="fas fa-check"></i> Vaccinations & Preventive Care – Immunizations and preventive
                            treatments to protect both mother and child.</li>
                        <li><i class="fas fa-check"></i> Education & Counseling – Sessions on pregnancy care, childbirth preparation, breastfeeding, and newborn care.</li>

                        <li><i class="fas fa-check"></i> High-Risk Pregnancy Management – Specialized monitoring and treatment for mothers with conditions such as hypertension, diabetes, or previous pregnancy complications.</li>

                    </ul>
                </div>
            </div>
            <div style="margin-top: 3rem;">
                <h3>Why Antenatal Care Matters</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Helps prevent complications by detecting risks early.
                        <li>
                        <li><i class="fas fa-check"></i> Helps prevent complications by detecting risks early.
                        <li>
                        <li><i class="fas fa-check"></i> Ensures proper fetal development and safe delivery.
                        <li>
                        <li><i class="fas fa-check"></i> Supports emotional and mental well-being during pregnancy.
                        <li>
                    </ul>
                </div>
            </div>
