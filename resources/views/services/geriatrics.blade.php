...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>Geriatrics</h1>
            <p>Geriatrics is the branch of medicine dedicated to the care of older adults, focusing on promoting healthy
                aging, preventing diseases, and managing medical, mental, and social conditions that commonly affect the
                elderly.</p>
        ...
        <div class="container">
            <div class="service-detail-content">
                <div class="service-detail-text fade-in">
                    <h3>Geriatrics</h3>
                    <p>Geriatrics is a specialized branch of medicine that focuses on the health, well-being, and
                        medical care of older adults, typically aged 60 and above. It addresses the unique physical,
                        emotional, and social needs of the elderly, aiming to improve quality of life, promote
                        independence, and support healthy aging.</p>
                    <p>As people age, they face challenges such as multiple chronic diseases, mobility issues, memory
                ...
                <div class="service-detail-image fade-in">
                    <img src="https://i.pinimg.com/736x/92/0f/40/920f40a326d0f9ae56e3de21babb21b6.jpg"
    ...
    <section>
        <div class="section-header">
            <h2>Key Areas of Geriatric Care</h2>
        </div>
        ...
        <div class="service-header">
            <div>
                ...
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Conditions like diabetes, hypertension, arthritis,
                            osteoporosis, and heart disease are carefully managed.</li>
            ...
            <div style="margin-top: 3rem;">
                <h3>Benefits of Geriatric Care</h3>
                <div>
                    <ul>
            ...
            <div style="margin-top: 3rem;">
                <h3>Who Provides Geriatric Care?</h3>
                <div>
                    <ul>
