...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>Ultrasound Services</h1>
            <p>Our Ultrasound Department provides safe, non-invasive imaging that uses sound waves to create real-time
                pictures of the body’s internal organs, tissues, and blood flow. It helps in diagnosing medical
                conditions, guiding treatments, and monitoring pregnancies with accuracy and comfort.</p>
        ...
        <div class="container">
            <div class="service-detail-content">
                <div class="service-detail-text fade-in">
                    ...
                    <p>Ultrasound, also known as sonography, is a safe, non-invasive diagnostic imaging technique that
                        uses high-frequency sound waves to create real-time images of the body’s internal structures.
                        Unlike X-rays or CT scans, ultrasound does not use radiation, making it one of the safest
                        imaging options, especially for pregnant women and children.</p>
                    <p>Ultrasound is a vital diagnostic tool that provides safe, accurate, and real-time insights into a
                        wide range of medical conditions. It plays an essential role in preventive care, diagnosis, and
                        treatment planning.</p>
                    <a href="{{ route('login') }}" class="btn btn-accent">Book
                        Appointment</a>
                </div>
                <div class="service-detail-image fade-in">
                    <img src="https://i.pinimg.com/1200x/85/d3/b6/85d3b6e26e1e420b8f62edeaad05ab84.jpg"
    ...
    <section>
        <div class="section-header">
            <h2>Key Areas of Ultrasound Services</h2>
        </div>

        <div class="service-header">
            <div>
                <h3>What Ultrasound Is Used For</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Obstetrics & Gynecology – Monitoring pregnancy, checking fetal growth, detecting abnormalities, and evaluating reproductive organs.</li>
                        <li><i class="fas fa-check"></i> Abdominal Imaging – Examining organs like the liver, gallbladder, pancreas, kidneys, and spleen.</li>
                        <li><i class="fas fa-check"></i> Cardiology (Echocardiography) – Assessing heart function, structure, and blood flow.</li>
                        <li><i class="fas fa-check"></i> Vascular Ultrasound – Checking blood flow in veins and arteries to detect blockages or clots.</li>
                        <li><i class="fas fa-check"></i> Musculoskeletal Imaging – Evaluating muscles, tendons, ligaments, and joints.</li>
                        <li><i class="fas fa-check"></i> Urology – Examining the bladder, prostate, and kidneys.</li>
                        <li><i class="fas fa-check"></i> Guided Procedures – Assisting with biopsies, fluid drainage, and other minimally invasive procedures.</li>
                    </ul>
                </div>
            </div>
            <div style="margin-top: 3rem;">
                <h3>Benefits of Ultrasound</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Safe and radiation-free – Ideal for repeated use and for sensitive groups like pregnant women.
                        <li>
                        <li><i class="fas fa-check"></i> Real-time imaging – Allows doctors to see moving structures like the beating heart or blood flow.
                        <li>
                        <li><i class="fas fa-check"></i> Non-invasive & painless – No surgical procedures required.
                        <li>
                        <li><i class="fas fa-check"></i> Quick results – Images are available immediately, allowing faster diagnosis.
                        <li>
                    </ul>
                </div>
            </div>
            ...
            <div style="margin-top: 3rem;">
                <h3>What to Expect During an Ultrasound</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> A clear gel is applied to the skin to allow smooth movement of the ultrasound probe and enhance sound wave transmission.
                        <li>
                        <li><i class="fas fa-check"></i> The technician or doctor moves the probe over the targeted area to capture images.
                        <li>
                        <li><i class="fas fa-check"></i> The procedure is typically painless and takes between 15 to 45 minutes, depending on the type of scan.
                        <li>
            ...
            <div style="margin-top: 3rem;">
                <h3>Why Choose Our Ultrasound Services</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Modern ultrasound machines with high-resolution imaging.
                        <li>
                        <li><i class="fas fa-check"></i> Experienced radiologists and sonographers.
                        <li>
                        <li><i class="fas fa-check"></i> A comfortable and patient-centered environment.
                        <li>
                            <li><i class="fas fa-check"></i> Comprehensive ultrasound services covering general, obstetric, gynecological, vascular, and cardiac imaging.
                        <li>
