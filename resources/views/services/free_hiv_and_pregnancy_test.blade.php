...
<body>
    ...
    <section>
        <div class="section-header">
            <h2>Key Areas of Free HIV & Pregnancy Testing</h2>
        </div>

        <div class="service-header">
            <div>
                <h3>Why Free HIV Testing is Important</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Early Detection: Knowing your HIV status helps you take charge
                            of your health. Early diagnosis allows for timely treatment with antiretroviral therapy
                            (ART), which helps you live a long and healthy life.</li>
                        <li><i class="fas fa-check"></i> Prevention: Testing reduces the spread of HIV by enabling
                            individuals to take preventive measures.</li>
                        <li><i class="fas fa-check"></i> Confidentiality: We ensure that all results remain private and
                            that you are supported with counseling services regardless of the outcome.</li>
                        <li><i class="fas fa-check"></i> Peace of Mind: Regular testing gives you assurance about your
                            health status.</li>
            ...
            <div style="margin-top: 3rem;">
                <h3>Why Free Pregnancy Testing is Important</h3>
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Early Awareness: Early confirmation of pregnancy allows mothers to start antenatal care and adopt healthy lifestyle choices right away.
                        <li>
                        <li><i class="fas fa-check"></i> Access to Support: Our team provides counseling and guidance on the next steps, whether continuing with prenatal care or discussing other options.
                        <li>
                        <li><i class="fas fa-check"></i> Safe & Accurate Results: We use reliable testing methods to provide quick and trustworthy outcomes.
                        <li>
                    </ul>
                </div>
            </div>
            ...
            <div style="margin-top: 3rem;">
                ...
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Completely Free: No hidden costs—both tests are offered at no charge.
                        <li>
                        <li><i class="fas fa-check"></i> Safe and Confidential: All services are handled by qualified professionals in a private and compassionate environment.
                        <li>
                        <li><i class="fas fa-check"></i> Holistic Care: We don’t just test; we guide you with the right medical, emotional, and social support you may need.
                        <li>
                    </ul>
                </div>
            </div>
            ...
            <div style="margin-top: 3rem;">
                ...
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> HIV Test: Anyone who is sexually active, pregnant women, and individuals who may have been exposed to risk factors.
                        <li>
                        <li><i class="fas fa-check"></i> Pregnancy Test: Women who have missed a menstrual period, are experiencing pregnancy symptoms, or want confirmation of pregnancy status.
                        <li>
                    </ul>
                </div>
            </div>
            ...
            <div style="margin-top: 3rem;">
                ...
                <div>
                    <ul>
                        <li><i class="fas fa-check"></i> Pre- and post-test counseling for HIV.
                        <li>
                        <li><i class="fas fa-check"></i> Referrals for antenatal care, family planning, or HIV treatment services.
                        <li>
                        <li><i class="fas fa-check"></i> Continuous care and follow-up to ensure long-term wellness.
                        <li>
                    </ul>
                </div>
            </div>
