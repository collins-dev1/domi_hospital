    ...
    <header class="header">
        <nav class="nav container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="{{route('contact_us')}}" class="active">Contact</a></li>
    ...
    <section class="hours-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Our operating hours for different services and departments</p>
            </div>
    ...
    <section class="departments-section">
        <div class="container">
            <div class="section-header">
                ...
                <p>Direct contact information for our specialized medical departments</p>
            </div>
            ...
            <div class="map-container">
                <div class="map-placeholder">
                    <div style="text-align: center;">
                        <i class="fas fa-map-marked-alt" style="font-size: 4rem; margin-bottom: 1rem; color: rgba(255,255,255,0.8);"></i>
                        <h3>Interactive Map</h3>
                        <p>123 Healthcare Street, Medical City, MC 12345</p>
                        <p>Integrate with Google Maps, MapBox, or similar mapping service</p>
                    </div>
                </div>
            </div>
        </div>
